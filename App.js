...
import { View, Text, StyleSheet, StatusBar, Image, KeyboardAvoidingView, Vibration, Alert } from 'react-native';
    ...
    <KeyboardAvoidingView style={styles.container} behavior="padding">
      ...
      <View style={styles.inputContainer}>
        ...
        <View style={styles.rutContainer}>
          <TextInput label="RUT" style={styles.input} value={rut} onChangeText={text => setRut(text)} />
        </View>
        <Text style={styles.passwordLabel}>CONTRASEÑA</Text>
        <View style={styles.passwordContainer}>
          <TextInput label="Contraseña" secureTextEntry style={styles.input} value={password} onChangeText={text => setPassword(text)} />
        </View>
